<div class="<?php echo $class;?> ecran">
    ...
    <div class="ecrans-liens">
        ...
        <a href="../slideshow/?plasma_id=<?php echo $id;?>&preview&debug" target="_blank" title="afficher en mode debug l'écran: <?php echo $nom;?>"><img src="../graphisme/eye.png" alt="voir"/></a>
